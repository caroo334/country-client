...
import {
  ...
  orderByName,
  orderByPopulation,
  getCountriesFilteredByActivities,
  getCountriesFilteredByContinent,
} from "../redux/actions";
//components
  ...
  return (
    <div className="home-container">
      <nav>
        ...
        <button
          onClick={(e) => handleChangeReload(e)}
        ...
        <select className="home-filter" onChange={handleCHangeContinentSelect}>
          ...
          {continents &&
            continents.map((c, index) => {
              return <option key={`${index}_${c}`}>{c}</option>;
            })}
        </select>
